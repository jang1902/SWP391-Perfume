                ...
                <script>
                    $(document).ready(function () {
                        $.validator.addMethod("passValidator", function (value, element, args) {
                            ...
                            //^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{7,15}$  (1 uppercase, 1 lowercase, 1 digit, 1 character)
                        }, 'Mật khẩu phải chứa ít nhất 1 kí tự hoa, 1 kí tự thường và 1 chữ số');
                    });
                        ...
                        $("#form_register").validate({
                            ...
                            messages: {
                                ...
                                "password": {
                                    ...
                                    minlength: "Vui lòng nhập ít nhất {0} ký tự",
                                    maxlength: "Vui lòng nhập tối đa {0} ký tự",
                                    passValidator: "Mật khẩu phải chứa ít nhất 1 kí tự hoa, 1 kí tự thường và 1 kí tự số"
                                },
                                "repassword": {
                                ...
                                "email": {
                                    ...
                                    maxlength: "Vui lòng nhập tối đa {0} ký tự",
                                    email: "Vui lòng điền email hợp lệ, ví dụ: example@gmail.com"
                                }
                            }
                        });
                    });
