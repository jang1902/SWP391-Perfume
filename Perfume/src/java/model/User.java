...
public class User {
    ...
    public User(int loginType, int role_id, String firstname, String lastname, String username, String password, String email, String phone_number, String address, Date created_at, Date updated_at, int deleted) {
        this.loginType = loginType;
        this.role_id = role_id;
        this.firstname = firstname;
        this.lastname = lastname;
