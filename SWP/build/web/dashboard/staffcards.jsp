...
<h5 class="card-title mt-8 fs-16 mb-3">Mary Sandra</h5>
<div class="card-text text-muted">
<p class="m-0">Seller ID: #409</p>
<p class="mb-0">mary90@example.com</p>
</div>
<a href="sellers-profile.html" class="btn btn-sm btn-primary fs-14 mt-3">View details</a>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-3 mb-6">
<div class="card card-user rounded-xl">
<div class="card-header text-center">
<img class="img-avatar" src="../img/avatar-2.png" alt="Leslie Alexander">
</div>
<div class="card-body text-center">
<h5 class="card-title mt-8 fs-16 mb-3">Leslie Alexander</h5>
<div class="card-text text-muted">
<p class="m-0">Seller ID: #478</p>
<p class="mb-0">leslie@example.com</p>
</div>
<a href="sellers-profile.html" class="btn btn-sm btn-primary fs-14 mt-3">View details</a>
</div>
</div>
...
<div class="card card-user rounded-xl">
<div class="card-header text-center">
<img class="img-avatar" src="../img/avatar-3.png" alt="Leslie Alexander">
</div>
<div class="card-body text-center">
<h5 class="card-title mt-8 fs-16 mb-3">Leslie Alexander</h5>
<div class="card-text text-muted">
...
<div class="card card-user rounded-xl">
<div class="card-header text-center">
<img class="img-avatar" src="../img/avatar-4.png" alt="Floyd Miles">
</div>
<div class="card-body text-center">
<h5 class="card-title mt-8 fs-16 mb-3">Floyd Miles</h5>
<div class="card-text text-muted">
<p class="m-0">Seller ID: #171</p>
<p class="mb-0">fedor12@example.com</p>
</div>
<a href="sellers-profile.html" class="btn btn-sm btn-primary fs-14 mt-3">View details</a>
</div>
</div>
...
<div class="card card-user rounded-xl">
<div class="card-header text-center">
<img class="img-avatar" src="../img/avatar-1.png" alt="John Alexander">
</div>
<div class="card-body text-center">
<h5 class="card-title mt-8 fs-16 mb-3">John Alexander</h5>
<div class="card-text text-muted">
<p class="m-0">Seller ID: #987</p>
<p class="mb-0">john@mymail.com</p>
</div>
<a href="sellers-profile.html" class="btn btn-sm btn-primary fs-14 mt-3">View details</a>
</div>
</div>
...
<div class="card card-user rounded-xl">
<div class="card-header text-center">
<img class="img-avatar" src="../img/avatar-3.png" alt="Albert Flores">
</div>
<div class="card-body text-center">
<h5 class="card-title mt-8 fs-16 mb-3">Albert Flores</h5>
<div class="card-text text-muted">
<p class="m-0">Seller ID: #478</p>
<p class="mb-0">leslie@example.com</p>
</div>
...
<div class="card card-user rounded-xl">
<div class="card-header text-center">
<img class="img-avatar" src="../img/avatar-4.png" alt="Leslie Alexander">
</div>
<div class="card-body text-center">
<h5 class="card-title mt-8 fs-16 mb-3">Leslie Alexander</h5>
<div class="card-text text-muted">
...
<div class="card card-user rounded-xl">
<div class="card-header text-center">
<img class="img-avatar" src="../img/avatar-1.png" alt="Leslie Alexander">
</div>
<div class="card-body text-center">
<h5 class="card-title mt-8 fs-16 mb-3">Leslie Alexander</h5>
<div class="card-text text-muted">
