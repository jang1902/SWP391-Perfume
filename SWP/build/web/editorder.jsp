                                    ...
                                    <div class="col-xxl-6">
                                        <div class="row mb-6">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <h2 class="fs-24 mb-0">Sửa đơn hàng</h2>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="mb-4">
                                                            <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="product-title">Người đặt hàng</label>
                                                            <input type="text" name="title" value="${product.title}" class="form-control bg-input border-0" id="product-title">
                                                        </div>
                                                        <div class="mb-4">
                                                            <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="description">Địa chỉ</label>
                                                            <textarea name="description" class="form-control bg-input border-0" rows="4" id="description">${product.description}</textarea>
                                                        </div>
                                                        <div class="mb-4">
                                                            <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="brand-name">Số điện thoại</label>
