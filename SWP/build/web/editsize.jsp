            ...
            <div class="d-flex flex-wrap flex-xl-nowrap">
                ...
                <div class="page-content">
                    ...
                    <main id="content" class="bg-gray-01 d-flex flex-column main-content">
                        <c:set var="s" value="${requestScope.size}"></c:set>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" name="namesize" placeholder="${s.name}" class="form-control bg-input border-0" id="product-title" value="${s.name}">
                                                        </div>
                                                        <div class="mb-4">
                                                            <label class="mb-2 fs-13 letter-spacing-01 font-weight-600 text-uppercase" for="description">Giá tri</label>
                                                            <input type="text" name="value" placeholder="${s.value}" class="form-control bg-input border-0" id="product-title" value="${s.value}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
